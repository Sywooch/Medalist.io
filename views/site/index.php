     ...
     <div id="videoMessage" >
        <div  class="owl-carousel owl-theme" style="width: 1000px; height: 70%; text-align: center; margin: 0 auto;">
            ...
            <div class="item">
                 ...
                 <h3>Тебе есть чем гордиться и нам тоже. Добавь свои достижения на доску почёта.</h3>
             </div>
            <div class="item">
                 <h1>Раздели радость своих побед с другими.</h1>
                 <h2>Поддержи их  в борьбе и они разделят с тобой радость своих достижений.</h2>
                 <h3></h3>
            </div>
            <div class="item">
                 <h1>Тебе есть о чем рассказать?</h1>
                 <h2>Есть чем гордится? Тебя есть за что уважать?</h2>
            ...
            <div class="item">
                 ...
                 <h3>Рудольф Коллер</h3>
             </div>
            <div class="item">
                 <h1>Достигай успеха2</h1>
                 <h2>...каждый день3</h2>
