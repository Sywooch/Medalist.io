      ...
      <div class="container-cols">
         ...
         <div class="container-col container-col-2">
            ...
            <div class="output">
               ...
               <a class="mygoals-block" href="<?=Yii::$app->urlManager->createUrl(['personal/goal', 'goal_id' => $goal->goal_id])?>">
                     ...
                     <div>
                        <ul class="goal-subtask">
                           <? 
                              ...
                              //var_dump($goal_subtasks[0]->goal_id);
                              foreach($goal->getGoalSubtasks() as $subtask){?>
                           <?=$subtask->goal_id?>
