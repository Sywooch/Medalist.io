				...
				<div class="container-cols">
					...
					<div class="container-col container-col-2">
						...
						<div class="output">
							<div class="output-header">
								 <div class="mygoals-name-div">
									<h2 class="mdlst-h2t-goals withButton">Мои цели (2)</h2>
							...
							<div class="goal-content">
   								 <div class="mygoals-name-div">
                                     <div class="input-check withList">
										...
										<label for="ListbGoal1" class="subtask-top-name" id="mygoals-name">Купить квартиру в Кудрово</label>
									</div>
									 <div class=""></div>
								</div>
							...
							<span class="showSubtasts">Смотреть подцели (5)</span>
