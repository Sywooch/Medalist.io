		 						...
		 						<form action="" name="addach">
			 						...
			 						<div class="addach-description">
			 							<div class="addach-description-text">
			 								<textarea name="" id="" cols="30" rows="10" class="addach-description-text-textarea"></textarea>
			 							</div>
			 							<div class="addach-description-date"><span class="addach-description-date-icon"></span><input data-toggle="datepicker" class="addach-description-date-date mdlst-input-small"></div>
			 						...
			 						<div class="addach-extra js-addach-isdifficult">
			 							<div class="addach-extra-range">
			 								...
			 								<div class="addach-extra-range-range"> <input type="range" data-toggle="rangeslider"  data-rangeslider min="1" max="100" step="1" value="50" ></div>
			 							</div>
									...
									<!-- add achievement  CONTROLLS -->
			 						<div class="addach-controlls">
			 							...
			 							<div class="addach-controlls-send">
			 								<button class="mdlst-button  mdlst-button-default">Добавить достижение</button>
			 							</div>
			 						</div>
			 						<!-- add achievement CONTROLLS end -->

			 						<div class="addach-important js-addach-isdifficult">
			 							<div class="mdlst-pan mdlst-pan-important">
			 								<div class="mdlst-pan-icon"></div>
			 								<div class="mdlst-pan-text">Вы собираетесь рассказать о серьёзном достижении своей жизни. Если большая часть сообщества вам не поверит, вы не получите награды и баллы за достижение. Если пользователи сочтут, что вы обманули, вы будете оштрафованы.</div>
			 							</div>
			 						</div>
