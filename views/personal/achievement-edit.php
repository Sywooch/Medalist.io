		 						...
		 						<form action="" name="addach" class="addachievement-form dropzone1">
									...
									<input type="hidden" value="<?=$achievement->achievement_id?>" placeholder="" name="achievement_id">
			 						...
			 						<div class="addach-description">
			 							...
			 							<div class="addach-description-date"><span class="addach-description-date-icon"></span><input data-toggle="datepicker" class="addach-description-date-date mdlst-input-small" name="date_achieved" value="<?=date("d.m.Y", strtotime($achievement->date_achieved) );?>"></div>
